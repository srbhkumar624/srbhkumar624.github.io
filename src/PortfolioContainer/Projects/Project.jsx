      ...
      <div className="projectMain" id="project">
        ...
        <div className="projectCardDiv">
          <div className="projectDetail">
            ...
            <p>
              Tripadvisor, Inc. is an American online travel company that
              operates a website and mobile app with user-generated content and
            ...
            <div className="links">
              <a
                ...
                href="https://github.com/srbhkumar624/opposite-beginner-5472"
              >
              ...
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://fanciful-buttercream-b9885f.netlify.app/"
              >
                <FaLink className="social-media-icon" />
              </a>
            </div>
            <div className="langDiv">
              ...
              <div className="texttackDiv">
                ...
                />
                <img
                  src="https://erons-blog.netlify.app/static/b7579add2ab1119a79026efd3d1af91e/6bc95/building-react-components-with-chakra-ui.webp"
        ...
        <div className="projectCardDiv secProject">
          <div className="projectDetail">
            <h3>Muscle Fit</h3>
            <p>
              About A MuscleFit is fitness application, that provides customer
              based customized workout plans and provide access to track them.{" "}
            </p>
            <div className="links">
              <a
                target="_blank"
              ...
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://musclefit-201.netlify.app/"
              >
                <FaLink className="social-media-icon" />
              </a>
            </div>
          ...
          <div className="projectImg secProjectImg">
            <img src=".././images/musclefit.png" alt="musclefit" />
          </div>
        </div>
        <div className="projectCardDiv secProject">
          <div className="projectDetail">
            ...
            <div className="links">
              ...
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://srbhkumar624.github.io/kfcclonewebsite/"
              >
                <FaLink className="social-media-icon" />
              </a>
            </div>
